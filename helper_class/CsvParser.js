...
var CsvParser = (function () {
    ...
    function CsvParser(collection, file, type, addressIndex, spaceIndex) {
        csvparser(file, function (err, output) {
            ...
            for (var i = 1; i < numRows; i++) {
                ...
                (function (i) {
                    ...
                    collection.update({ 'address': parkAddress }, { $setOnInsert: { 'type': type, 'address': parkAddress, 'space': numSpace, 'lat': lat, 'lng': lng, 'comment': '' } }, { upsert: true });
                })(i);
            }
