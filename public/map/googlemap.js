...
(function (Mapping) {
    var GoogleMap = (function () {
        ...
        GoogleMap.prototype.addMarkers = function (parkinglist) {
            var markers = [];
            for (var i = 0; i < parkinglist.length; i++) {
                var lat = parkinglist[i].lat;
                var lng = parkinglist[i].lng;
                console.log('my lat is:' + lat);
        ...
        GoogleMap.prototype.removeOneMarker = function (marker) {
            marker.setMap(null);
        };
        GoogleMap.prototype.removeMarkersFarAway = function (markers) {
