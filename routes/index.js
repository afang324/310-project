...
var ReadDataFiles = require('../helper_class/ReadDataFiles');
var AccountManager = require('../helper_class/AccountManager');
var Geocoder = require('../helper_class/Geocoder');
var Router = (function () {
    function Router() {
        //Initialize AccountManager and create an admin
        var adminname = 'aname';
        var adminpwd = 'apassword';
        ...
        router.post('/updatedatabase', function (req, res) {
            var permission = accmgr.authenticate('admin');
            if (!permission) {
        ...
        router.get('/profilepage', function (req, res) {
            ...
            collection.find({ 'username': accmgr.getUsername() }, {}, function (e, docs) {
                ...
                if (docs[0] == null) {
                    ...
                    var user = docs[0];
                    var password = '';
                    var plength = ('' + docs[0].password).length;
        ...
        router.post('/updateuser', function (req, res) {
            ...
            var pwdconfirmation = req.body.pwdconfirmation;
            var db = req.db;
            var collection = db.get('usercollection');
            ...
            if (newname != '') {
                collection.find({ 'username': newname }, {}, function (e, docs) {
                    ...
                    if (docs[0] != null) {
                        ...
                        collection.update({ 'username': accmgr.getUsername() }, { $set: { 'username': newname } });
            ...
            if (newpwd != '') {
                if (newpwd == pwdconfirmation) {
                    collection.update({ 'username': accmgr.getUsername() }, { $set: { 'password': newpwd } });
        ...
        router.get('/newparking', function (req, res) {
            var permission = accmgr.authenticate('user');
            if (!permission) {
